	...
	case 'Weather':
		...
		case 'Grup bot':
			if (args.length >=2) {
				...
				client.sendText(from, 'SILAHKAN JOIN KE GRUP https://chat.whatsapp.com/Ko7R3oTphRwKUirNtjmbuL UNTUK MENDAPATKAN LEBIH BANYAK STIKER*')
}
		    break
                case 'Kontak':
                    ...
                    break
		case 'Support':
                        client.sendText(from, '*Kalo Ada Yang Mau Support Boleh Ke* : \n *Dana*: 089636035164 \n *Gopay*: 089636035164 \n *OVO*: 089636035164 \n *Atau Pulsa Juga Bisa Ke* 085155335454 (By.U) \n *Atau Bisa Juga Lewat* saweria.co/donate/dandisubhani \n *Terima Kasih Lumayan Buat Nambahin Script xixixi*' )
                   break
                ...
                case 'Bot' :
                case 'bot' :
                        client.sendText(from, '*Ada apa manggil saya?*')
                    break 
                case 'Kamu bot?' :
                        client.sendText(from, '*Bisa jadi*')
                    break 
		case 'P' :
                        client.sendText(from, '*Kenapa?*')
                    break
               case 'Hai' :
               case 'hai' :
                        client.sendText(from, '*Apa Sayang?*')
                    break
                case 'freedom' :
		...
		case 'Toxic':
		    ...
		    break
                case 'Fitur lain' :
                        client.sendText(from, '*Fitur Lain* : .\n1. Mysteri Video: Video Misteri \n2. dfb *spasi URL* : Untuk Mendownload Video Dari Facebook. \n3. ytmp3 *spasi URL* : Untuk Convert Video dari Youtube Menjadi Mp3* \n4. Kontak: Kontak Owner. \n5. Support: Untuk Support Server Bot Agar Terus Berjalan. \n6. Grup bot: Untuk Join Ke Grup Bot \n *Fitur Waifu,Pokemon,Neko di hilangkan Karena Banyaknya Spam* \n *Copyright © 2020 Powered by Dandi.*')
                    break
                case 'dfb':
                    if (args.length >=2) {
                        const urlvid = args[1]
